...
/**
 * AStar class utilizes A* search techniques to find the puzzle goal state based
...
public class AStar {
	...
	public AStar(gameBoard board, String options, PrintWriter pw) {
		this.pw = pw;
		expandedNodes = 0;
		this.node = board;
		...
		numCreated = 1;
		size = 1;
		//adds first node to the fringe. Parent is null, true because this is AStar search. 
		//First node is initial puzzle state (entered by user) 
		fringe.add(new Node(null,node, true));
